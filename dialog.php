...
if(empty($_SESSION["uid"])) {header("location:portal.php");
?>
...
<form method="post">
<b> Add more article in wiki Portal </b>
<table>
<tr>
<div class="inputs">
    <td><input type="submit" name="confirm" value="Yes"></td><br/>
    </tr>
    <tr>
        <td><input type="submit" name="confirm" value="No"></td><br/>
    </tr>
    </table>
</div>
    </form>
