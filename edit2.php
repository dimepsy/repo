...
$count=0;
	...
	$sql="SELECT  title, description, email, file, status FROM upload2 WHERE id='$postid'";
...
<div class = "content4" >
				...
				<form id="myform" action="editupdate2.php?eid=<?php echo $postid?>" method='post' enctype="multipart/form-data"><br>                                                                                                                
                    <?php echo "<b>Researched Topic :&nbsp </b><input class='input' type='text' enable='false' name='nop' value='$b' readonly> <br><br><br>";?>
